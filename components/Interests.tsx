...
// Duplicate for seamless infinite loop — second set is purely visual
...
export default function Interests() {
  ...
  return (
    <>
      {/* CSS keyframe for the continuous scroll — injected once */}
      <style>{`
        ...
        .interests-track {
          animation: interests-scroll 48s linear infinite;
          will-change: transform;
        }
        .interests-outer:hover .interests-track {
      ...
      <section id="interests" className="relative py-20 md:py-32" ref={ref}>
        ...
        {/* Full-width marquee — overflows the padded container */}
        <div
          className="interests-outer"
          style={{
            overflow: 'hidden',
            paddingBottom: 12,
            paddingTop: 4,
          ...
          >
            {marqueeItems.map((item, index) => (
              <motion.div
                ...
                className="group relative rounded-2xl backdrop-blur-sm overflow-hidden flex-shrink-0"
                style={{
                  width: 320,
                  padding: '28px',
              ...
              >
                ...
                >
                  {String((index % interests.length) + 1).padStart(2, '0')}
                </div>
